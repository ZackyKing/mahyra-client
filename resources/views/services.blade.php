    ...
    <div class="container mx-auto px-6 pt-24 lg:pt-32 pb-20">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition">
                    ...
                    <div class="relative h-64 bg-gradient-to-br from-pink-100 to-pink-200">
                        ...
                        <!-- Price Tag -->
                        <div class="absolute top-4 right-4 bg-red-700 text-white px-4 py-2 rounded-full text-sm font-bold">
                            {{ $service['price'] }}
                        </div>
                        
                        <!-- Category Badge -->
                        <div class="absolute top-4 left-4 bg-gray-200 bg-opacity-90 text-gray-700 px-3 py-1 rounded-full text-xs font-medium">
                            {{ $service['category'] }}
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <!-- Reservasi Button -->
                        <a href="{{ route('reservasi', ['service_id' => $service['id']]) }}" class="w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-brand-btn-dark text-white rounded-lg font-medium hover:bg-gray-800 transition">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="text-center">
                <button class="px-8 py-3 bg-white border-2 border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition inline-flex items-center gap-2">
